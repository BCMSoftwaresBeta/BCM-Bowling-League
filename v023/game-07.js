...
function renderCareerHub(){
 ...
 document.getElementById('careerHubContent').innerHTML=`
   <div class="career-grid">
     <div class="metric-card"><div class="metric-kicker">All-Time High Game</div><div class="metric-main">${highGame?highGame.emoji+' '+highGame.name+' · '+highGame.allTimeHigh:'—'}</div><div class="metric-sub">Includes the historical record entering this save.</div></div>
     <div class="metric-card"><div class="metric-kicker">Best Season Total</div><div class="metric-main">${highSeason&&highSeason.bestSeasonTotal?highSeason.emoji+' '+highSeason.name+' · '+highSeason.bestSeasonTotal:'—'}</div><div class="metric-sub">Best completed regular season in Career Mode.</div></div>
     <div class="metric-card"><div class="metric-kicker">Ring Leader</div><div class="metric-main">${ringKing?ringKing.emoji+' '+ringKing.name+' · '+(ringKing.championships||0):'—'}</div><div class="metric-sub">Career championships.</div></div>
     <div class="metric-card"><div class="metric-kicker">MVP Leader</div><div class="metric-main">${mvpKing?mvpKing.emoji+' '+mvpKing.name+' · '+totalMVPs(mvpKing):'—'}</div><div class="metric-sub">Regular-season + playoff MVPs.</div></div>
     <div class="metric-card"><div class="metric-kicker">Longest Title Drought</div><div class="metric-main">${drought?drought.emoji+' '+drought.name+' · '+currentTitleDrought(drought)+' yrs':'—'}</div><div class="metric-sub">Longest championship gap in completed career years.</div></div>
